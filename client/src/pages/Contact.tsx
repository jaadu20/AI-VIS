        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-lg">
              Have questions about AI-VIS or need assistance with your account? Our team is ready to help you make the most of our AI-powered interview platform.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-800 font-medium">support@ai-vis.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-800 font-medium">123 Tech Park, San Francisco, CA</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative bg-white p-6 rounded-xl shadow-2xl">
              ...
              <form className="space-y-5">
                ...
                <div className="space-y-1">
                  <label className="text-sm font-medium text-gray-700" htmlFor="email">Your Email</label>
                  <div className="relative">
                ...
                <motion.div whileHover={{ scale: 1.02 }}>
                  <Button
                    className="w-full bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 shadow-lg shadow-blue-200/50 flex items-center justify-center gap-2"
                  >
                    Send Message
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-600 text-lg">
              Find quick answers to the most common questions about our AI-powered video interview platform.
            </p>
          </div>
            ...
            {[
              {
                ...
                answer: "Our AI uses natural language processing and machine learning to analyze verbal responses, facial expressions, and voice tone to provide comprehensive candidate assessment based on job-specific criteria."
              },
              {
                question: "Is my data secure on your platform?",
                answer: "Absolutely. We implement bank-level encryption, strict access controls, and comply with GDPR, CCPA, and other privacy regulations to ensure your data is always protected."
              },
              {
                question: "How long does it take to set up an interview?",
                answer: "You can set up a complete interview in less than 10 minutes. Our intuitive interface guides you through job requirement definition, question selection, and candidate invitation."
              },
              {
                question: "Can I customize the interview questions?",
                answer: "Yes, you can fully customize the question bank or use our AI-recommended questions based on the job description. You can also set specific criteria for the AI to evaluate candidates."
              },
              {
                question: "Do candidates need special software?",
                answer: "No, candidates only need a web browser and a webcam. Our platform is browser-based with no downloads required, making it accessible for candidates worldwide."
              },
              {
                question: "How do you prevent AI bias in evaluations?",
                answer: "Our AI is regularly tested and updated to mitigate bias. We focus on job-relevant skills and behaviors, not demographic factors, and provide transparency in our evaluation criteria."
              },
            ].map((faq, index) => (
              <motion.div
                key={index}
